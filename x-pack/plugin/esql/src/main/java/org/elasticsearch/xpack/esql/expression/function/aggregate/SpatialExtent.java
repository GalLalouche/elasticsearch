    ...
    public AggregatorFunctionSupplier supplier() {
        ...
        return switch (type) {
            case DataType.GEO_POINT -> switch (fieldExtractPreference) {
                ...
                case NONE, EXTRACT_SPATIAL_BOUNDS, STORED, SOURCE_HACKER ->
                    new SpatialExtentGeoPointSourceValuesAggregatorFunctionSupplier();
            };
            case DataType.CARTESIAN_POINT -> switch (fieldExtractPreference) {
                ...
                case NONE, EXTRACT_SPATIAL_BOUNDS, STORED, SOURCE_HACKER ->
                    new SpatialExtentCartesianPointSourceValuesAggregatorFunctionSupplier();
            };
            case DataType.GEO_SHAPE -> switch (fieldExtractPreference) {
                ...
                case NONE, STORED, SOURCE_HACKER -> new SpatialExtentGeoShapeSourceValuesAggregatorFunctionSupplier();
            ...
            case DataType.CARTESIAN_SHAPE -> switch (fieldExtractPreference) {
                ...
                case NONE, STORED, SOURCE_HACKER -> new SpatialExtentCartesianShapeSourceValuesAggregatorFunctionSupplier();
                case DOC_VALUES -> throw new EsqlIllegalArgumentException("Illegal field extract preference: " + fieldExtractPreference);
            };
